...
public class ModelModel implements Cvor {
	...
	private Vector<Dokument>dokumenti;
	...
	public ModelModel() {
		this.dokumenti=new Vector<Dokument>();
	...
	public Vector<Dokument> getDokumenti() {
		return dokumenti;
	}
	public void setDokumenti(Vector<Dokument> dokumenti) {
