...
public class ToolboxView extends JPanel {
	...
	public ToolboxView() {
		...
		zoomInButton.setLocation(105,1);
		zoomInButton.setSize(new Dimension(40,38));
		firstRowPanel.add(zoomInButton);
		
		zoomOutButton = new JButton();
		zoomOutButton.setIcon(new ImageIcon("./icons/zoomout.png"));
		zoomOutButton.setBorder(BorderFactory.createEmptyBorder());
		zoomOutButton.setLocation(155,1);
		zoomOutButton.setSize(new Dimension(40,38));
		...
		firstRowPanel.add(zoomOutButton);
